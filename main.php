...
.bootstrap-select .dropdown-menu {
 ...
 <body class="appear-animate">
					...
					?>
                     <div class="inner-nav desktop-nav" style='background-color:black'>
                        <ul class="clearlist">
                            ...
                            <li>
                                <a href="#" style='color:white' class="active">Balance Rs.<?php echo $balance;?></a>
                            </li>
                            <!-- End Cart -->
	...
	if(mysqli_num_rows($result) > 0)
	{
		while($row = mysqli_fetch_array($result))
		{
         ...
         <form method="post"> 
			...
			<br><br><label style='color:red'><b>Price:</b></label> Rs <?php echo $d['price'] ?> </div></center> 
	...
	if(!empty($_SESSION["cart"]))
	{
        ...
        <td align="right"><p style="margin: 10px;" class="font-alt">Rs <?php echo number_format($total, 2); ?></p></td>
	...
	if(!empty($_SESSION["cart"]))
	{
        ...
        <tr>
        <td colspan="3" align="left"><h3 style="margin: 10px;" class="font-alt">Total</h3></td>
        <td align="right"><p style="margin: 10px;" class="font-alt">Rs <?php $_SESSION["total"]=number_format($total, 2); echo number_format($total, 2); ?></p></td>
		</td>
        </tr>
        <?php
	}
